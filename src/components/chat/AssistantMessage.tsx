...
import type { ChatMessage, ChatMessageMeta } from "./ChatContainer";
...
export function AssistantMessage({
  ...
  return (
    <div className="flex items-start gap-3 ci-fade-up group">
      {/* Avatar */}
      <div
      ...
      <div className="min-w-0 max-w-[85%]">
        ...
        >
          ...
          {showSql && meta?.queryExecuted && (
            <pre
              className="mt-2 overflow-x-auto rounded-lg p-3 text-[11px] ci-fade-in"
