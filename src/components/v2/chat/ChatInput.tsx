  ...
  return (
    <div className="px-4 pb-4 pt-2">
      <div className="mx-auto max-w-3xl">
        <div className="relative rounded-2xl transition-all v2-input-glow" style={{ background: "var(--ci-bg-surface)", border: "1px solid var(--ci-border)", boxShadow: "var(--ci-shadow-md)" }}>
          <textarea
            ref={textareaRef}
            value={input}
          ...
          <button
            ...
            style={{ background: input.trim() ? "linear-gradient(135deg, var(--ci-navy), #5A6B8A)" : "var(--ci-border)" }}
          >
            <IconSend className="h-4 w-4" />
          </button>
        </div>
        <p className="mt-2 text-center text-[10px]" style={{ color: "var(--ci-text-muted)" }}>
